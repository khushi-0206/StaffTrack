...
using TimeSheetService.API.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "StaffTrack TimeSheet API", Version = "v1" });
    c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        Description = "JWT Authorization (same secret/issuer/audience as Auth Service).",
        Name = "Authorization",
